    ...
    public class ProcessingService : IProcessingService
    {
        ...
        public void Create(ProcessingViewModel input, string userId)
        {
            Ticket ticketOut = new Ticket
            {
                ...
                TotalVolume = input.ProcessingOutViewModel.TotalVolume * input.ProcessingOutViewModel.Coefficient,
                Place = "Processing",
                In = false,
                UserId = userId,
            };
            ...
            Ticket ticketIn = new Ticket
            {
                ...
                TotalVolume = input.ProcessingInViewModel.TotalVolume * input.ProcessingInViewModel.Coefficient,
                Place = "Processing",
                In = true,
                UserId = userId,
            };
